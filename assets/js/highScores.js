...
highScoresList.innerHTML = highScores
  .map((score) => {
    return `<li class="flex justify-between items-center bg-violet-100 rounded-xl p-4"><p><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
</p> <p>${score.name}</p><p>${score.score}</p></li>`;
  })
  .join("");
